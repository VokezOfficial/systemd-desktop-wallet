...
TradeTab.prototype.angular = function(module)
{
                                            ...
                                            $timeout, $document, $sce)
  {
    ...
    function onBlobIsValid() {
      ...
      // Remember user preference on Convert vs. Trade
      if (!settings.getSetting($scope.userBlob, 'systemdExchangeSelectionTrade', false)) {
        $scope.userBlob.set('/clients/systemd/systemdExchangeSelectionTrade', true);
      }
    }
    ...
    function update_pairs() {
      ...
      if (!settings.hasSetting($scope.userBlob, 'trade_currency_pairs')) {
        $scope.pairs_query = [
          { name: 'XRP/EMC.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/DGB.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/XIM.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'BTC.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw/XRP' },
          { name: 'XRP/VTC.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/VIA.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/ETH.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/EMN.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/DSH.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/GRS.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/BTG.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/BCH.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/IOT.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/XMR.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/XLM.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/MON.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/NAV.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/GUP.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/BSD.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/EXP.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/XSD.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/LOG.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/NMC.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/PPC.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' },
          { name: 'XRP/LTC.rUPKfbT8GzBy11qHHEue1ENLeqTF5idWQw' }
        ];
      }
      else {
        $scope.pairs_query = settings.getSetting($scope.userBlob, 'trade_currency_pairs');
    ...
    */
    ...
    var updateTradeChart = function(){
      ...
      $scope.tradeEmbeddedHTML = $sce.trustAsHtml("<iframe "
        + "src='http://sydcharts.io/embed/pricechart?theme=light&type=candlestick&counter=" + $scope.tradeChartJsonCounter + "=&base=" + $scope.tradeChartJsonBase + "&live=true' "
